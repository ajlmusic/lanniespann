...
--
-- Name: acl_type; Type: TYPE; Schema: public; Owner: chmbc
--
...
ALTER TYPE public.acl_type OWNER TO chmbc;
...
--
-- Name: admins; Type: TABLE; Schema: public; Owner: chmbc
--
...
--
-- Name: admins_id_seq; Type: SEQUENCE; Schema: public; Owner: chmbc
--
...
ALTER TABLE public.admins_id_seq OWNER TO chmbc;

--
-- Name: admins_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: chmbc
--
...
--
-- Name: p_ballot; Type: TABLE; Schema: public; Owner: chmbc
--
...
--
-- Name: p_ballot_codes; Type: TABLE; Schema: public; Owner: chmbc
--

CREATE TABLE public.p_ballot_codes (
    id integer NOT NULL,
    p_ballot_code uuid DEFAULT public.uuid_generate_v4() NOT NULL,
    initials character varying(20) NOT NULL
);


ALTER TABLE public.p_ballot_codes OWNER TO chmbc;

--
-- Name: p_ballot_codes_id_seq; Type: SEQUENCE; Schema: public; Owner: chmbc
--

CREATE SEQUENCE public.p_ballot_codes_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.p_ballot_codes_id_seq OWNER TO chmbc;

--
-- Name: p_ballot_codes_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: chmbc
--

ALTER SEQUENCE public.p_ballot_codes_id_seq OWNED BY public.p_ballot_codes.id;
...
--
-- Name: admins id; Type: DEFAULT; Schema: public; Owner: chmbc
--
...
--
-- Name: p_ballot_codes id; Type: DEFAULT; Schema: public; Owner: chmbc
--

ALTER TABLE ONLY public.p_ballot_codes ALTER COLUMN id SET DEFAULT nextval('public.p_ballot_codes_id_seq'::regclass);
...
--
-- Name: admins admins_pkey; Type: CONSTRAINT; Schema: public; Owner: chmbc
--
...
--
-- Name: admins admins_username_key; Type: CONSTRAINT; Schema: public; Owner: chmbc
--
...
--
-- Name: audit audit_userid_key; Type: CONSTRAINT; Schema: public; Owner: chmbc
--

ALTER TABLE ONLY public.audit
    ADD CONSTRAINT audit_userid_key UNIQUE (userid);
...
--
-- Name: p_ballot_codes p_ballot_codes_pkey; Type: CONSTRAINT; Schema: public; Owner: chmbc
--

ALTER TABLE ONLY public.p_ballot_codes
    ADD CONSTRAINT p_ballot_codes_pkey PRIMARY KEY (id);


--
-- Name: p_ballot p_ballot_paper_ballot_id_key; Type: CONSTRAINT; Schema: public; Owner: chmbc
--

ALTER TABLE ONLY public.p_ballot
    ADD CONSTRAINT p_ballot_paper_ballot_id_key UNIQUE (paper_ballot_id);


--
-- Name: p_ballot p_ballot_pkey; Type: CONSTRAINT; Schema: public; Owner: chmbc
--

ALTER TABLE ONLY public.p_ballot
    ADD CONSTRAINT p_ballot_pkey PRIMARY KEY (ballot_id);
...
--
-- Name: roster roster_create_rosterkey_trigger; Type: TRIGGER; Schema: public; Owner: chmbc
--

CREATE TRIGGER roster_create_rosterkey_trigger AFTER INSERT ON public.roster FOR EACH ROW EXECUTE FUNCTION public.roster_create_code();
